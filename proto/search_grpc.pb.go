...
func (c *searchServiceClient) Search(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedSearchServiceServer) Search(context.Context, *Request) (*Response, error) {
